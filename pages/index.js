...
import { faCss3, faDev, faHtml5, faJs, faNodeJs, faPython, faGithub, faLinkedin, faInstagram } from '@fortawesome/free-brands-svg-icons';
...
export default function Home({ dir }) {
  ...
  return (
    <>
      ...
      <main
        dir={dir} className={`${rubik.className}`} 
      >
        <Flowbite>
        <Header />
        ...
        <section className="bg-white dark:bg-gray-900 antialiased" id="home">
                    ...
                    <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                        ...
                        <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                            ...
                            <a href="Curriculum Actual.pdf" target="_blank" className="mr-5 mb-20 pb-10 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
                                <i className="fa-regular fa-file-pdf fa-2xl"></i><FontAwesomeIcon icon={faFilePdf} className="fas fa-file-pdf" style={{ color: "red", fontSize: 32 }}/> CV                                        
                            </a>
                            <a href="/Current Resume.pdf" target="_blank" className="mr-5 mb-20 pb-10 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
                                <i className="fa-regular fa-file-pdf fa-2xl"></i><FontAwesomeIcon icon={faFilePdf} className="fas fa-fa-file-pdf" style={{ color: "red", fontSize: 32 }}/> Resume                   
                            </a>           
                        </div>
                    </div>  
        </section>
                    ...
                    <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
                      ...
                      <div className="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
                        <div className="space-y-4">
                          ...
                          <FontAwesomeIcon icon={faHtml5} className="fa-brands fa-html5" style={{ color: "blue", fontSize: 128 }}/>                    
                        ...
                        <div className="space-y-4">
                        <FontAwesomeIcon icon={faCss3} className="fa-brands fa-css3" style={{ color: "blue", fontSize: 128 }}/> 
                          {/* <span
                            className="bg-gray-100 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                            Microsoft Corp.
                          </span>
                        ...
                        <div className="space-y-4">
                        <FontAwesomeIcon icon={faJs} className="fa-brands fa-js" style={{ color: "orange", fontSize: 128 }}/> 
                          {/* <span
                            className="bg-gray-100 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                            Adobe Inc.
                          </span>
                      ...
                      <div className="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
                        <div className="space-y-4">
                          ...
                          <FontAwesomeIcon icon={faNodeJs} className="fa-brands fa-node-js" style={{ color: "green", fontSize: 128 }}/>                    
                          {/* <h3 className="text-2xl font-bold leading-tight text-gray-900 dark:text-white">
                            HTML
                          </h3> */}
                          {/* <p className="text-lg font-normal text-gray-500 dark:text-gray-400">
                        ...
                        <div className="space-y-4">
                        <FontAwesomeIcon icon={faPython} className="fa-brands fa-python" style={{ color: "blue", fontSize: 128 }}/> 
                          {/* <span
                            className="bg-gray-100 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                            Microsoft Corp.
                          </span>
                        ...
                        <div className="space-y-4">
                        <FontAwesomeIcon icon={faDev} className="fa-brands fa-dev" style={{ color: "blue", fontSize: 128 }}/> 
                          {/* <span
                            className="bg-gray-100 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                            Adobe Inc.
                          </span>
        ...
        {/* Proyectos */}
        <section className="bg-white dark:bg-gray-900 antialiased" id="projects">
                    <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
                      <div className="max-w-2xl mx-auto text-center">
                        <h2 className="text-3xl font-extrabold leading-tight tracking-tight text-gray-900 sm:text-4xl dark:text-white">
                          Projects
        ...
        {/* Follow */}
        <section className="bg-white dark:bg-gray-900 antialiased" id="follow">
                    <div className="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
                      <div className="max-w-2xl mx-auto text-center">
                        <h2 className="text-3xl font-extrabold leading-tight tracking-tight text-gray-900 sm:text-4xl dark:text-white">
                          Follow me on...
                        ...
                        <div className="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
                          <div className="space-y-4">
                            {/* <span
                              ...
                              <a href="https://github.com/aayalas" target="_blank"><FontAwesomeIcon icon={faGithub} className="fa-brands fa-github" style={{ color: "grey", fontSize: 128 }}/></a>
                          ...
                          <div className="space-y-4">
                            <a href="https://www.linkedin.com/in/alejandroayalas" target="_blank"><FontAwesomeIcon icon={faLinkedin} className="fa-brands fa-linkedin" style={{ color: "blue", fontSize: 128 }}/> </a>
                            {/* <span
                              className="bg-gray-100 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                              Microsoft Corp.
                            </span>
                          ...
                          <div className="space-y-4">
                            <a href="https://instagram.com/alexayalaschmitt" target="_blank"><FontAwesomeIcon icon={faInstagram} className="fa-brands fa-instagram" style={{ color: "red", fontSize: 128 }}/> </a>
                            {/* <span
                              className="bg-gray-100 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                              Adobe Inc.
                            </span>
